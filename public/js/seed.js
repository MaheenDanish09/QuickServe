...
export const SEED_PROVIDERS = [
  {
    id: "seed_plumb", name: "Daniel Rivera", email: "daniel@servihub.demo",
  ...
  {
    id: "seed_elec", name: "Aisha Khan", email: "aisha@servihub.demo",
  ...
  {
    id: "seed_clean", name: "Maria Santos", email: "maria@servihub.demo",
  ...
  {
    id: "seed_carp", name: "James Carter", email: "james@servihub.demo",
  ...
  {
    id: "seed_paint", name: "Leo Martins", email: "leo@servihub.demo",
  ...
  {
    id: "seed_garden", name: "Nadia Bloom", email: "nadia@servihub.demo",
